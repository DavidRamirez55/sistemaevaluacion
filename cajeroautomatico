...
public class CajeroAutomatico {
    ...
    // Procedimiento que muestra el saldo
    ...
    // Procedimiento que realiza un depósito
    ...
    // Procedimiento que realiza un retiro
    ...
    // Procedimiento principal que controla el flujo del programa
